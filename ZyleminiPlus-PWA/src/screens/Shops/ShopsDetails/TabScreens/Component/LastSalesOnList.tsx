...
export default function LastSalesOnList(props: ListProps) {
  ...
  return (
    ...
    >
      <DialogContent sx={{ p: 0 }}>
        <HeaderOrderSales
          VhrNo={headerData[0]?.VoucherNumber || ''}
          ChalanNumber={headerData[0]?.ChalanNumber || ''}
          distributorName={headerData[0]?.Distributor || ''}
          expectedDelivery=""
          outletName=""
          startdate={headerData[0]?.ChalanDate || '--/--'}
          storeId=""
          totalDiscount={0}
          totalOrders={headerData[0]?.Voucherdate || '--/--'}
          isSalesOn={true}
