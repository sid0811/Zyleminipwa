...
export default function DataCList2(props: List1Props) {
  const { t } = useTranslation();
  const { Party, check_date, id, item_Name, quantity_one, quantity_two } = props;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Box sx={{ flex: 1 }}>
            <Typography sx={{ color: '#666666', fontSize: 12, mb: 0.5 }}>
        ...
        <Box>
          ...
          >
            {t('ColectionCard.ColectionCardStock')}
          </Typography>
          <Typography
            sx={{
              color: '#666666',
          ...
          >
            {t('ColectionCard.ColectionCardDateAsOn')}
          </Typography>
          <Typography sx={{ color: '#333333', fontSize: 14, fontWeight: 600 }}>
            {check_date}
          </Typography>
