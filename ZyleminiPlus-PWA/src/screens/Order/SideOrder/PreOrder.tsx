...
function PreOrders(props: PreOrdersProps): React.ReactElement {
  ...
  const takeDataFromDB = async (): Promise<void> => {
    getAllOrders1(userId).then(data => {
      setAllOrder(data);
      console.log("Shankar gade Preorder check", data);
    });
